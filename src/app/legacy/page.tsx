      ...
      <AnimatedSection>
        <header className="rule-thick-thin pt-3">
          ...
          <p className="mt-3 max-w-3xl text-ink-faded">
            Революция 1905 года создала в Екатеринбурге три ресурса для 1917-го —
            кадровый, институциональный и символический. Ниже — шесть
            измерений долгосрочного влияния и пять ключевых событий
            долгого эха.
          </p>
        </header>
      </AnimatedSection>
      ...
      <AnimatedSection className="mt-16">
        <div className="archive-dark rounded-sm p-8">
          <p className="font-display text-xs uppercase tracking-[0.3em] opacity-60">
            «Генеральная репетиция» — верифицируемый вывод
          </p>
          <h2 className="mt-2 max-w-3xl font-display text-2xl leading-snug md:text-3xl">
            «Революция 1905 года в Екатеринбурге отработала все ключевые
            институты, воспроизведённые в 1917-м: Совет, боевые дружины,
            заводские комитеты, массовые митинги. Для Екатеринбурга эта
            преемственность подкреплена и персонально: Свердлов 1905-го стал
            Свердловым 1917-го.»
          </h2>
          <p className="mt-4 font-mono text-[10px] uppercase tracking-widest opacity-60">
            §5.3. По В.Л. Харитонову (1993)
          </p>
        </div>
      </AnimatedSection>
    </div>
