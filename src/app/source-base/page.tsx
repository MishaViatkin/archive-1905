      ...
      <AnimatedSection className="mt-10">
        <div className="doc-card relative rounded-sm p-6 md:p-8">
          ...
          <h2 className="mt-8 font-display text-2xl text-ink">
            Ссылки на архивные фонды не приводятся
          </h2>
          <p className="mt-4 leading-relaxed text-ink/85">
            Ссылки на архивные фонды (ГАСО, ГАПК, ЦДООСО) в тексте работы{" "}
            <strong>не приводятся</strong> — поскольку автор не имел возможности
            работать в читальных залах указанных архивов. Там, где
            исследователи-историки (А.В. Чернов, В.П. Микитюк) опираются на
            архивные материалы, их выводы цитируются с указанием на
            соответствующие научные публикации.
          </p>
          <p className="mt-3 leading-relaxed text-accent">
            Такой подход честнее, чем воспроизведение вторичных ссылок под
            видом самостоятельно верифицированных данных.
          </p>
        </div>
      </AnimatedSection>
